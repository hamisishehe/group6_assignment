...
import { MonitoringStatus, MonitorResponse } from '../models/fullModel';
...
export class MonitorComponent implements OnInit {
  ...
  selectedStudent: any = {};  // will store student info for editing
    ...
    fullmonitor: MonitorResponse | null = null;
    website_id : number=0;
    website_name : string = '';
...
GetFullInfo() {
  ...
  if (token) {
    ...
    this.http.get<MonitorResponse>(`http://localhost:5000/history/${this.website_id}`, { headers })
      .subscribe(
        response => {
          this.fullmonitor = response;
                   console.log("1.....................................................................");
